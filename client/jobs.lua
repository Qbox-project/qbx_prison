        ...
        for i = 1, #Config.Locations.jobs[k] do
            ...
            if Config.UseTarget then
                exports.ox_target:addBoxZone({
                    ...
                    options = {
                        {
                            event = 'qb-prison:work_' .. k .. '_' .. i,
                            icon = 'fa-solid fa-bolt',
                            label = Lang:t("info.job_interaction_target", {
                                job = Config.Jobs[k]
                            }),
                ...
                lib.zones.box({
                    ...
                    rotation = current.rotation,
                    onEnter = function(_)
                        isInside = inJail and currentJob and not Config.Locations.jobs[k][i].done and not isWorking
